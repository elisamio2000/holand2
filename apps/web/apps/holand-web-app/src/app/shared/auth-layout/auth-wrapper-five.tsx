...
export default function AuthWrapperFive({
  ...
  return (
    <>
      <div className="sticky top-0 z-20 flex w-full items-center justify-between border-gray-300 bg-blue p-4 py-2 text-sm font-medium text-white lg:absolute lg:start-1/2 lg:-translate-x-1/2 lg:bg-transparent lg:text-gray-700 xl:py-6">
        <Link
          href={'/'}
        ...
        >
          <div
            className={cn(
              'flex items-center lg:mx-auto lg:w-full lg:max-w-5xl xl:w-auto xl:max-w-7xl xl:ps-[60px] 2xl:max-w-[1432px] 2xl:ps-0',
              backHomeClassName
            )}
          >
            <PiArrowLeftBold />
        ...
        <LanguageSwitcher variant="outline" size="sm" className="lg:border-gray-300 lg:text-gray-700 lg:hover:border-gray-900 lg:hover:text-gray-900" />
      </div>
        ...
        >
          ...
          >
            <div className="mb-10 px-4 text-center lg:px-0 lg:text-start">
              <Link
                href={'/'}
                className="mb-6 inline-flex max-w-[220px] text-gray-900 dark:text-white xl:mb-8"
              >
                <Logo className="h-8 w-auto md:h-9" alt={siteConfig.title} />
              </Link>
              <Title
                as="h2"
