  ...
  return (
    ...
    !isPathExcluded && (
      <>
        <button
          className={cn(
            'fixed right-2 top-1/2 z-20 grid -translate-y-1/2 place-content-center gap-1 rounded-md bg-primary p-3 text-xs font-semibold text-primary-foreground shadow-[0_25px_50px_-12px_#000000]',
            className
          )}
