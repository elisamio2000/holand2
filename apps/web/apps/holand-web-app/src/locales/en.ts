...
const en = {
  ...
  expertLab: {
    title: 'Expert Analyst Lab',
    subtitle: 'Version-controlled management of questions and scoring formulas, from draft to publish.',
    tabs: { drafts: 'Drafts', review: 'Review queue', published: 'Published' },
    status: {
      draft: 'Draft',
      in_review: 'In review',
      approved: 'Approved',
    ...
    kind: { question: 'Question', formula: 'Scoring formula' },
    form: {
      title: 'Title',
      kind: 'Content kind',
  ...
  analyticsDashboard: {
    ...
    subtitle: 'Step-by-step event logging and drop-off rate between steps.',
    totalSessions: 'Total sessions',
    step: 'Step',
